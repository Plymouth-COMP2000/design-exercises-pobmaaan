...
import com.example.restaurantapp.databinding.FragmentCreateReservationBinding;
...
public class CreateReservationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.buttonSaveReservation.setOnClickListener(v -> {
            ...
            if (!name.isEmpty() && !coversStr.isEmpty() && !time.isEmpty()) {
                try {
                    ...
                    Toast.makeText(requireContext(), "Reservation submitted for approval", Toast.LENGTH_SHORT).show();
                    NavHostFragment.findNavController(this).popBackStack();
